...
: ${AMENT_CURRENT_PREFIX:="/home/alpaka-admin/my_alpaka_urdf_ws/install/alpaka_welding_cobot_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/alpaka_welding_cobot_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/alpaka_welding_cobot_moveit_config/environment/path.sh"
