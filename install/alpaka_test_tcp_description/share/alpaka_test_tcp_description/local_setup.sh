...
: ${AMENT_CURRENT_PREFIX:="/home/alpaka-admin/my_alpaka_urdf_ws/install/alpaka_test_tcp_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/alpaka_test_tcp_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/alpaka_test_tcp_description/environment/path.sh"
