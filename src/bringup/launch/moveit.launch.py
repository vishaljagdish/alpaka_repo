...
def launch_setup(context, *args, **kwargs):
    ...
    alpaka_welding_cobot_moveit_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare("alpaka_welding_cobot_moveit"), "launch", "alpaka_welding_cobot_moveit.launch.py"])),
        launch_arguments={
    ...
    ml_model_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare("ml_model"), "launch", "ml_model.launch.py"])),
    )
    output = [
        alpaka_welding_cobot_moveit_launch,
